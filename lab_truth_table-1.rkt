...
;;-------------------------------------------------------------------------------
;; Name: Kai qi Chee
;; Pledge: 1 pledge my honor that I have abided by the Stevens Honor System.
;;-------------------------------------------------------------------------------
...
(define (3majority p q r)
  (or (and p q r) (and p (not q) r) (and (not p) q r) (and p q (not r))))
...
(define (isosceles p q r)
  (or (and p (not q) r) (and (not p) q r) (and p q (not r))))
